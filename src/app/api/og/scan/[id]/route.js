...
async function getScanData(id) {
  try {
    ...
    return {
      ...
      headersAnalyzed: scan.headers ? Object.keys(scan.headers).length : null,
      createdAt: scan.createdAt ? new Date(scan.createdAt).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }) : null,
    };
  } catch {
    return null;
  }
    ...
    React.createElement(
      ...
      React.createElement("div", {
        style: {
          ...
          background: "linear-gradient(90deg, transparent 0%, #00c6a0 30%, #00e5b9 50%, #00c6a0 70%, transparent 100%)",
        },
      }),
      /* Top-right glow blob */
      React.createElement("div", {
      ...
      React.createElement("div", {
        style: {
          display: "flex", position: "absolute", bottom: -60, left: -60, width: 300, height: 300,
          borderRadius: "50%", background: "radial-gradient(circle, rgba(0,198,160,0.06) 0%, transparent 70%)",
        },
      }),
